    ...
    <Layout>
      ...
      <div className="flex-1 p-8 bg-background min-h-screen">
            ...
            <DialogContent className="w-[95vw] max-w-lg mx-auto bg-background border-border max-h-[85vh] flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row gap-2 pt-4 border-t border-gray-800">
                ...
                <Button
                  ...
                  className="flex-1 bg-[#3B82F6] hover:bg-[#3B82F6]/90 text-foreground border-0 w-full sm:w-auto"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <Card className="bg-background border-gray-800 hover:border-[#3B82F6]/50 transition-colors cursor-pointer">
          ...
          <Card className="bg-background border-gray-800 hover:border-[#3B82F6]/50 transition-colors cursor-pointer">
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-[#3B82F6]/10 rounded-lg flex items-center justify-center">
                  <Webhook className="w-6 h-6 text-[#3B82F6]" />
                </div>
                <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        {integration.type === 'SMTP' ? (
                          ...
                          <Webhook className="w-5 h-5 text-[#3B82F6]" />
