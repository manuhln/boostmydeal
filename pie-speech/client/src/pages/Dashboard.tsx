        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Welcome back! Track your Arabic AI calling performance.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-2">
              <Link href="/call-logs">
                <Button 
                  className="bg-[#3B82F6] hover:bg-[#3B82F6]/90 text-white border-0 w-full sm:w-auto"
                  size="sm"
                >
              ...
              <Link href="/agents">
                <Button 
                  variant="outline" 
                  className="border-[#3B82F6] text-[#3B82F6] hover:bg-[#3B82F6]/10 w-full sm:w-auto"
                  size="sm"
                >
