            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
              ...
              >
                <DialogTrigger asChild>
                  <Button
                    className="bg-[#3B82F6] hover:bg-[#E63600] text-white w-full sm:w-auto py-4 px-6"
                    size="default"
                  >
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 sm:justify-end pt-4">
                      ...
                      <Button
                        ...
                        className="bg-[#3B82F6] hover:bg-[#E63600] text-white w-full sm:w-auto disabled:opacity-50"
                      >
              ...
              <Button
                ...
                className="bg-[#3B82F6] hover:bg-[#E63600] text-white"
              >
          ...
          <Card className="bg-card border-gray-800 overflow-hidden">
            <CardContent className="p-0">
              <div className="overflow-x-auto rounded-lg">
                <Table>
                  <TableHeader>
                    <TableRow className="border-gray-800 bg-[#3B82F6]">
                                ...
                                {(call as any).user_tags?.length > 0 ? (
                                  <div className="flex items-center gap-1">
                                    ...
                                    {(expandedTagRows.has(callId)
                                      ...
                                      <span
                                        key={`tag-${tagIndex}`}
                                        className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-[#3B82F6]/20 text-[#3B82F6] border border-[#3B82F6]/30"
                                      >
                                        {tag}
                                      </span>
                                    ))}
            ...
            <div className="flex items-center justify-between px-4 py-4 bg-card border border-gray-800 rounded-lg mt-4">
              ...
              <div className="flex items-center space-x-2">
                <Button
                  ...
                  className="border-[#3B82F6] text-[#3B82F6] hover:bg-[#3B82F6] hover:text-white disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  ...
                  {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                    ...
                    return (
                      <Button
                        ...
                        className={
                          currentPage === pageNum
                            ? "bg-[#3B82F6] text-white hover:bg-[#E63600]"
