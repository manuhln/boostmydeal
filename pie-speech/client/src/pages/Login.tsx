      ...
      <div className="max-w-md w-full space-y-6 sm:space-y-8">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="text-center">
                  <p className="text-sm text-gray-400">
                    ...
                    <Link href="/signup" className="font-medium text-[#3B82F6] hover:text-[#E63600] border-b border-[#3B82F6] hover:border-[#E63600]">
                      Sign up for free
                    </Link>
                  </p>
                </div>
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-gray-400">
            ...
            <Link href="/forgot-password" className="text-[#3B82F6] hover:text-[#3B82F6]/80 font-medium">
              Reset it here
            </Link>
          </p>
