    ...
    <div className="container mx-auto py-8 space-y-8">
      <div className="flex items-center justify-between">
        ...
        <Dialog open={inviteDialogOpen} onOpenChange={setInviteDialogOpen}>
          <DialogTrigger asChild>
            <Button className="bg-[#3B82F6] hover:bg-[#E63900]">
          ...
          <DialogContent className="w-[95vw] max-w-md mx-auto bg-background border border-border max-h-[85vh] overflow-y-auto">
            ...
            <DialogFooter className="flex flex-col sm:flex-row gap-2 sm:gap-0">
              ...
              <Button
                ...
                className="bg-[#3B82F6] hover:bg-[#E63900] w-full sm:w-auto"
              >
      ...
      <Tabs defaultValue="members" className="w-full">
        <TabsList className="grid w-full grid-cols-2 bg-gray-900">
          <TabsTrigger value="members" className="data-[state=active]:bg-[#3B82F6]">Team Members</TabsTrigger>
          <TabsTrigger value="invites" className="data-[state=active]:bg-[#3B82F6]">Pending Invites</TabsTrigger>
        </TabsList>
