      ...
      <div className="flex gap-3">
        {Object.entries(NODE_CONFIGS).map(([type, config]) => {
          ...
          return (
            ...
            >
              <div className="p-3 bg-card rounded-lg border border-border hover:border-[#3B82F6] transition-colors">
    ...
    <div className="w-96 bg-card border-l border-border p-6 overflow-y-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex gap-2 pt-4">
          <Button type="submit" className="flex-1 bg-[#3B82F6] hover:bg-[#E63600] text-white">
            Save Configuration
          </Button>
