...
router.post('/signup', [
  ...
  try {
    ...
    try {
      ...
      await sendEmail({
        to: email,
        subject: 'Welcome to Pie-Speech - #1 Arabic AI Calling Platform! 🎉',
        html: `
          <!DOCTYPE html>
          <html lang="en">
          <head>
            ...
            <title>Welcome to Pie-Speech</title>
            <style>
              ...
              .feature-highlight { background-color: #f8f9fa; padding: 20px; margin: 20px 0; border-left: 4px solid #3B82F6; border-radius: 4px; }
              .features-list { list-style: none; padding: 0; margin: 20px 0; }
              .features-list li { padding: 10px 0; border-bottom: 1px solid #eee; }
              .features-list li:before { content: "✓"; color: #3B82F6; font-weight: bold; margin-right: 10px; }
              .arabic { direction: rtl; text-align: right; color: #3B82F6; font-weight: bold; margin: 10px 0; }
            </style>
          </head>
          <body>
            <div class="header">
              <h1 style="color: #3B82F6; margin: 0;">Pie-Speech</h1>
              <p style="margin: 5px 0; font-size: 14px;">#1 Arabic AI Calling Platform</p>
              <p class="arabic">منصة الاتصال الذكي الرائدة للعملاء العرب</p>
            </div>
            
            <div class="content">
              <h2 style="color: #3B82F6; margin-bottom: 20px;">Welcome to Pie-Speech! 🎉</h2>
              <p>Hello ${firstName},</p>
              <p>Congratulations on joining <strong>Pie-Speech</strong>! We're excited to have you and <strong>${organizationName}</strong> as part of the premier Arabic AI calling platform.</p>
              
              <div class="feature-highlight">
                <h3 style="color: #3B82F6; margin-top: 0;">What You Can Do with Pie-Speech:</h3>
                <ul class="features-list">
                  <li><strong>Arabic AI Voice Agents:</strong> Create intelligent voice agents optimized for Arabic-speaking customers</li>
                  <li><strong>Workflow Automation:</strong> Build visual workflows to automate your Arabic communication processes</li>
                  <li><strong>Call Management:</strong> Track, analyze, and optimize all your Arabic phone interactions</li>
                  <li><strong>Real-time Analytics:</strong> Monitor performance with comprehensive dashboards designed for Arabic markets</li>
                  <li><strong>CRM Integration:</strong> Connect with HubSpot, Zoho, and other popular CRM platforms</li>
                  <li><strong>Team Collaboration:</strong> Invite team members and manage roles for your Arabic operations</li>
                </ul>
              </div>
              
              <p>Your account is now active and ready to use. Start by creating your first Arabic AI agent or exploring our pre-built workflow templates designed for Arabic customers.</p>
              
              
              <p><strong>Need Help Getting Started?</strong></p>
              <p>Check out our documentation, watch tutorial videos, or contact our support team if you have any questions. We're here to help you make the most of Pie-Speech for your Arabic business needs!</p>
              
              <p>Welcome aboard!</p>
              <p>The Pie-Speech Team</p>
            </div>
            
            <div class="footer">
              <p><strong>Pie-Speech</strong> - #1 Arabic AI Calling Platform</p>
              <p class="arabic">منصة الاتصال الذكي الرائدة للعملاء العرب</p>
...
router.post('/forgot-password', [
  ...
  try {
    ...
    const baseUrl = process.env.APP_URL || 'https://portal.pie-speech.com';
    ...
    await sendEmail({
      to: email,
      subject: 'Reset Your Password - Pie-Speech',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
          <meta charset="UTF-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Password Reset - Pie-Speech</title>
          <style>
            body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; }
            .header { text-align: center; padding: 20px 0; border-bottom: 2px solid #3B82F6; margin-bottom: 30px; }
            .content { padding: 20px 0; }
        ...
        <body>
          ...
          <div class="content">
            ...
            <p>We received a request to reset the password for your Pie-Speech account associated with <strong>${email}</strong>.</p>
