  ...
  generateInvoiceEmailHTML(invoiceData: InvoiceData): string {
    return `
      ...
      <head>
        ...
        <title>Monthly Invoice - Pie-Speech</title>
        <style>
          body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; }
          .header { text-align: center; padding: 20px 0; border-bottom: 2px solid #3B82F6; margin-bottom: 30px; }
          .content { padding: 20px 0; }
          .invoice-header { background-color: #f8f9fa; padding: 20px; margin: 20px 0; border-left: 4px solid #3B82F6; border-radius: 4px; }
          ...
          .payment-table th { background-color: #3B82F6; color: white; font-weight: bold; }
          ...
          .total-amount { font-size: 24px; font-weight: bold; color: #3B82F6; text-align: center; margin: 20px 0; }
      ...
      <body>
        ...
        <div class="content">
          <h2 style="color: #3B82F6; margin-bottom: 20px;">Monthly Invoice - ${invoiceData.billingPeriod}</h2>
          
          <div class="invoice-header">
            <h3 style="margin-top: 0; color: #3B82F6;">Invoice Details</h3>
          ...
          <h3 style="color: #3B82F6;">Payment Summary</h3>
          ...
          <div class="summary-box">
            <h3 style="color: #3B82F6; margin-top: 0;">Billing Summary</h3>
            ...
            <div style="display: flex; justify-content: space-between; margin: 10px 0; border-top: 1px solid #ddd; padding-top: 10px;">
              ...
              <span style="color: #3B82F6; font-weight: bold;">$${invoiceData.remainingBalance.toFixed(4)}</span>
            </div>
          </div>
          ...
          <p><strong>Account Status:</strong> Your Pie-Speech account is ${invoiceData.remainingBalance > 1 ? 'active' : 'low on credits'}. 
          ${invoiceData.remainingBalance <= 1 ? 'Please consider adding credits to continue using our services.' : ''}</p>

          <p>Thank you for using Pie-Speech! If you have any questions about this invoice, please don't hesitate to contact our support team.</p>
          
          <p>Best regards,<br>The Pie-Speech Team</p>
        </div>
        ...
        <div class="footer">
          ...
          <p>© ${new Date().getFullYear()} Pie-Speech. All rights reserved.</p>
  ...
  async sendMonthlyInvoice(organizationId: string, month: number, year: number): Promise<{ success: boolean; message: string }> {
    try {
      ...
      await sendEmail({
        ...
        subject: `Monthly Invoice - ${invoiceData.billingPeriod} | Pie-Speech`,
        html: htmlContent
      });
