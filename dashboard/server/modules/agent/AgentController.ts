...
export class AgentController {
  ...
  static createAgent = ResponseUtil.handleAsync(async (req: AuthRequest, res: Response) => {
    ...
    console.log('🎹 [AgentController] Creating agent with keyboard sound:', {
      keyboardSound: createDto.keyboardSound,
      enableCallTransfer: createDto.enableCallTransfer,
      bodyKeys: Object.keys(createDto)
    });
    ...
    console.log('✅ [AgentController] Agent created with keyboard sound:', {
  ...
  static updateAgent = ResponseUtil.handleAsync(async (req: AuthRequest, res: Response) => {
    ...
    console.log('🔄 [AgentController] Received agent update request:', {
      ...
      keyboardSound: updateDto.keyboardSound,
    ...
    console.log('✅ [AgentController] Agent update completed:', {
      ...
      keyboardSound: updatedAgent.keyboardSound
    });
