...
router.post(
  ...
  IntegrationController.saveIntegrationConfig
);
router.post(
  "/test",
  authMiddleware,
  testConfigValidation,
  IntegrationController.testIntegrationConfig
);
router.post(
  "/:configId/test-email",
  authMiddleware,
...
router.post(
  ...
  authMiddleware,
  getDealValidation,
  IntegrationController.getDealByName
);
router.delete(
  "/:configId",
  authMiddleware,
...
router.post(
  "/:configId/action",
  authMiddleware,
  performActionValidation,
  IntegrationController.performAction
);

// Zoho token generation route
router.post(
  "/zoho/tokens",
  authMiddleware,
  [
    ...
    body("redirectUri").optional(),
    body("region")
      .optional()
      .isIn(["com", "eu", "in", "au", "jp", "ca"])
      .withMessage("Invalid region"),
  ],
  IntegrationController.generateZohoTokens
);
