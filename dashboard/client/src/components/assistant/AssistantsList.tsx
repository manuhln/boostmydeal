    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 lg:p-6 border-b border-border">
        ...
        <div className="relative">
          <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#F74000] w-4 h-4" />
          <Input
            placeholder="Search Assistants"
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            className="pl-10 border-[#F74000] focus:ring-[#F74000] focus:border-[#F74000]"
          />
        </div>
      </div>
        ...
        {filteredAgents.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full p-6">
            ...
            <Button 
              ...
              className="bg-[#F74000] hover:bg-[#F74000]/90 text-white border-0"
            >
              ...
              return (
                <div
                  ...
                  className={`p-4 rounded-lg cursor-pointer transition-colors mb-2 border-2 ${
                    selectedId === agentId
                      ? "bg-[#F74000]/10 border-[#F74000]"
                      : "border-[#F74000]/30 hover:border-[#F74000]/60 hover:bg-muted/50"
                  }`}
              >
                <div className="flex items-start space-x-3">
                  <Avatar className="h-10 w-10 mt-1">
                    <AvatarImage 
                      ...
                      alt={agent.name} 
                    />
                    <AvatarFallback className="bg-[#F74000]/10 text-[#F74000]">
