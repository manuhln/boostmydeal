        ...
        <div className="space-y-2">
          ...
          <div 
            className={`border-2 border-dashed rounded-lg p-4 text-center transition-colors ${
              isUploading 
                ? "border-[#F74000] bg-[#F74000]/10 cursor-not-allowed" 
                : "border-[#F74000]/50 cursor-pointer hover:border-[#F74000] hover:bg-[#F74000]/5"
            }`}
            onClick={() => {
              if (!isUploading) {
          ...
          >
            <div className="space-y-2">
              <Upload className={`h-6 w-6 mx-auto ${isUploading ? "text-[#F74000] animate-pulse" : "text-[#F74000]"}`} />
              <div className="text-sm text-muted-foreground">
                {isUploading ? (
                  <p className="text-[#F74000] font-medium">Uploading and processing PDFs...</p>
                ) : (
                  <>
                    ...
                    <p className="text-xs text-[#F74000] font-medium">
            ...
            return (
              ...
              >
                <div className="flex items-center space-x-3 flex-1">
                  ...
                  <FileText className="h-4 w-4 text-[#F74000]" />
              ...
              {selectedItems.map((itemId) => {
                ...
                return (
                  <Badge 
                    key={itemId}
                    variant="secondary"
                    className="bg-[#F74000]/10 text-[#F74000] hover:bg-[#F74000]/20"
                  >
                    ...
                    <button
                      ...
                      className="ml-1 hover:bg-[#F74000]/30 rounded-full p-0.5"
                    >
                      <X className="h-3 w-3" />
                    </button>
                  </Badge>
