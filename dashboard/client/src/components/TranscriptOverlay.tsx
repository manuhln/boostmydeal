      ...
      <div className={`fixed left-0 top-0 h-full w-96 bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-white shadow-2xl z-[60] transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="border-b border-gray-200 dark:border-gray-800 p-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <span className="text-[#F74000] text-lg font-bold">Transcriber</span>
              {isLiveCall && (
                <Badge className="bg-[#F74000] text-white animate-pulse text-xs">
                  LIVE
                </Badge>
              )}
            </div>
          ...
          {callStatus && (
            <div className="w-full p-3 rounded-lg bg-[#F74000] flex items-center justify-center">
            ...
            {isLoading ? (
              <div className="flex items-center justify-center h-full">
                <div className="flex flex-col items-center gap-2">
                  <Loader2 className="w-6 h-6 animate-spin text-[#F74000]" />
                    ...
                    <div className="flex-1 min-w-0 max-w-[85%]">
                      ...
                      <div className="mb-1">
                        <span className={`text-xs font-medium ${
                          message.speaker === 'user' ? 'text-blue-500 dark:text-blue-400' : 'text-[#F74000]'
                        }`}>
                      ...
                      <div className={`p-3 rounded-lg ${
                        message.speaker === 'user'
                          ...
                          : 'bg-[#F74000]/20 border border-[#F74000]/30'
                      }`}>
        ...
        {isLiveCall && (
          <div className="border-t border-gray-200 dark:border-gray-800 p-3">
            <div className="flex items-center gap-2 text-[#F74000]">
              <div className="flex space-x-1">
                <div className="w-2 h-2 bg-[#F74000] rounded-full animate-bounce"></div>
                <div className="w-2 h-2 bg-[#F74000] rounded-full animate-bounce" style={{animationDelay: '0.1s'}}></div>
                <div className="w-2 h-2 bg-[#F74000] rounded-full animate-bounce" style={{animationDelay: '0.2s'}}></div>
              </div>
