      ...
      <div className="flex h-full bg-background text-foreground">
        ...
        <div className="w-96 bg-background border-r border-border p-6">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Info className="h-4 w-4 text-muted-foreground hover:text-[#F74000] cursor-help transition-colors" />
                  </TooltipTrigger>
          ...
          <div className="space-y-6">
            {/* Name Field */}
            <div>
              <Label className="text-[#F74000] text-sm font-medium mb-2 block">Name</Label>
              <Input
            ...
            {/* Description Field */}
            <div>
              <Label className="text-[#F74000] text-sm font-medium mb-2 block">Description</Label>
              <Textarea
                rows={4}
            ...
            <div>
              <Label className="text-[#F74000] text-sm font-medium mb-2 block">Upload Document</Label>
              <div 
                className="border-2 border-dashed border-border rounded-lg p-6 text-center cursor-pointer hover:border-[#F74000] transition-colors"
              ...
              >
                {selectedFile ? (
                  <div className="space-y-2">
                    <FileText className="h-8 w-8 mx-auto text-[#F74000]" />
                  ...
                  <>
                    <Upload className="h-8 w-8 mx-auto text-[#F74000] mb-3" />
                    ...
                    <Button 
                      variant="outline" 
                      size="sm"
                      className="border-[#F74000] text-[#F74000] hover:bg-[#F74000] hover:text-foreground"
                    >
                      Browse Files
                    </Button>
                  </>
            ...
            {/* Website URL Section */}
            <div>
              <Label className="text-[#F74000] text-sm font-medium mb-2 block">Website URL</Label>
              <Input
            ...
            {/* Save Button */}
            <Button 
              className="w-full bg-[#F74000] hover:bg-[#F74000]/90 text-foreground"
              onClick={handleSave}
