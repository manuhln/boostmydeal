        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <Button 
              ...
              className="bg-[#F74000] hover:bg-[#E63900] w-full"
            >
              Go to Login
            </Button>
          </div>
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <BoostMyLeadLogo width={120} height={60} className="mx-auto mb-8" />
          <div className="flex justify-center mb-6">
            <div className="p-3 bg-[#F74000]/20 rounded-full">
              <UserPlus className="h-8 w-8 text-[#F74000]" />
            </div>
          </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                ...
                className="w-full bg-[#F74000] hover:bg-[#E63900] text-white"
              >
        ...
        <div className="text-center">
          <p className="text-sm text-gray-400">
            ...
            <button
              onClick={() => navigate('/login')}
              className="text-[#F74000] hover:text-[#E63900] font-medium"
            >
              Sign in here
            </button>
          </p>
