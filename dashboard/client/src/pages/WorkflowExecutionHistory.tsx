          ...
          <Card className="bg-[#141414] border-gray-700">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#F74000]/10 rounded-lg">
                  <Calendar className="h-5 w-5 text-[#F74000]" />
                </div>
                <div>
                        ...
                        <TableRow key={execution._id} className="border-gray-700">
                          ...
                          <TableCell>
                            <Button
                              ...
                              className="text-[#F74000] hover:bg-[#F74000] hover:text-white"
                            >
                                      ...
                                      {execution.callSession.payloads.map((payload: any, index: number) => (
                                        <div key={index} className="bg-gray-900 rounded p-3">
                                          <div className="flex items-center justify-between mb-2">
                                            <Badge variant="outline" className="text-[#F74000] border-[#F74000]/30">
                                              {payload.type}
                                            </Badge>
