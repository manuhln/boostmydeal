    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-black py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full text-center">
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#F74000] mx-auto"></div>
        ...
        <Card className="bg-gray-900 border-gray-800 shadow-2xl">
          <CardHeader className="space-y-1 pb-4">
            <CardTitle className="text-xl text-center text-foreground flex items-center justify-center gap-2">
              {resetSuccess ? (
                ...
                <>
                  <Key className="w-5 h-5 text-[#F74000]" />
                  New Password
                </>
              )}
            </CardTitle>
          ...
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <Link href="/login" className="text-sm text-[#F74000] hover:text-[#F74000]/80 font-medium inline-flex items-center gap-1">
